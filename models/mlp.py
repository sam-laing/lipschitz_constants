...
class MLP(nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim, activation='relu', separate_bias=True):
        super(MLP, self).__init__()
        self.separate_biases = separate_bias
        ...
        if separate_bias:
            ...
            nn.init.kaiming_normal_(W1, a=0, mode='fan_in', nonlinearity=activation)
            ...
            nn.init.kaiming_normal_(W2, a=0, mode='fan_in', nonlinearity=activation)
...
if __name__ == "__main__":
    ...
    model_with_bias = MLP(input_dim=10, hidden_dim=20, output_dim=5, activation='relu', separate_bias=False)
    model_without_bias = MLP(input_dim=10, hidden_dim=20, output_dim=5, activation='relu', separate_bias=True)
