...
DATA_DIR = os.path.join(os.path.dirname(__file__), "mnist_5k")
...
if __name__ == "__main__":
    ...
    train_ds = torchvision.datasets.MNIST(root=raw_dir, train=True, download=True)
    test_ds = torchvision.datasets.MNIST(root=raw_dir, train=False, download=True)
